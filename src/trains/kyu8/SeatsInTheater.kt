...
* turned out to be awfully dull. It's so bad you want to sneak out, which is quite simple, especially
* since the exit is located right behind your row to the left. All you need to do is climb over your
* seat and make your way to the exit. The main problem is your shyness: you're afraid that you'll end
* up blocking the view (even if only for a couple of seconds) of all the people who sit behind you and
* in your column or the columns to your left. To gain some courage, you decide to calculate the number
...
* row and column you're sitting in, return the number of people who sit strictly behind you and in your
